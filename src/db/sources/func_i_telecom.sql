create function i_telecom(t_type_id_val integer, amount_val integer, cur_val integer, oper_date date, oper_type character, src_card integer, comm_val character) returns integer
    language plpgsql
as
$$
DECLARE
