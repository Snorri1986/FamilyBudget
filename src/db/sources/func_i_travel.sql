...
BEGIN
    ...
    IF oper_type = 'Cash' THEN
        ...
        VALUES (0,amount_val,oper_date,comm_val,get_last_login(),curr_val);
...
$function$
;
COMMENT ON FUNCTION public.i_travel(int4, int4, int4, date, bpchar, int4, bpchar, bpchar) IS 'insert travel operation';
